...
export const WORKOUTS: Workout[] = [
	{
		...
		description:
			"Build upper body pushing strength with this comprehensive workout",
		duration: "60-75 min",
...
export const DIET_PLANS: DietPlan[] = [
	{
		...
		description:
			"High-protein, calorie surplus diet for building muscle mass",
		calories: "2600 kcal",
		protein: "180g",
		carbs: "335g",
		fats: "60g",
		meals: [
			...
			},
			{
				...
				description:
					"Greek yogurt with granola and berries, protein shake",
			},
			{
				time: "1:00 PM",
				name: "Lunch",
				description:
					"8oz grilled chicken, 2 cups brown rice, steamed vegetables",
			},
			{
				time: "4:00 PM",
				name: "Pre-Workout",
	...
	},
	{
		...
		description:
			"High-protein, moderate carb diet for fat loss while preserving muscle",
		calories: "2000 kcal",
		protein: "160g",
		carbs: "180g",
		fats: "60g",
		meals: [
			{
				...
				name: "Breakfast",
				description:
					"4 egg whites, 1 whole egg, 1 cup oatmeal, berries",
			},
			{
				time: "10:00 AM",
				name: "Mid-Morning Snack",
			...
			},
			{
				...
				name: "Lunch",
				description:
					"6oz grilled chicken, quinoa, large salad with olive oil",
			},
			{
				time: "4:00 PM",
				name: "Pre-Workout",
	...
	},
	{
		...
		description:
			"Balanced macros for maintaining current weight and performance",
		calories: "2500 kcal",
		protein: "170g",
		carbs: "280g",
		fats: "75g",
		meals: [
			{
				...
				name: "Breakfast",
				description:
					"3 whole eggs, 2 slices whole grain toast, avocado",
			},
			{
				time: "10:30 AM",
				name: "Mid-Morning Snack",
