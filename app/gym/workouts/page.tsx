    ...
    <>
      ...
      <main className="min-h-screen bg-background">
        <div className="mx-auto max-w-7xl px-4 py-12">
          <div className="mb-12">
            <h1 className="text-balance text-4xl font-bold mb-4">Workout Plans</h1>
            <p className="text-pretty text-lg text-muted-foreground">
              Choose from our expert-designed workout plans for different goals and experience levels
            </p>
          </div>
            ...
            {WORKOUTS.map((workout) => (
              ...
              >
                ...
                <div className="border-t border-border pt-4">
                  <h4 className="font-semibold mb-3">Exercises Preview</h4>
