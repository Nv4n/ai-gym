    ...
    <>
      ...
      <main className="min-h-screen bg-background">
        <div className="mx-auto max-w-7xl px-4 py-12">
          {/* Back Link */}
          <Link href={categoryUrl} className="inline-flex items-center text-primary hover:underline mb-8">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="space-y-4">
                <SignedOut>
                  ...
                  <p className="text-sm text-muted-foreground text-center">Must be signed in to purchase</p>
                </SignedOut>
                <SignedIn>
              ...
              <div className="mt-12 space-y-4 pt-8 border-t">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">100% authentic products with full satisfaction guarantee</p>
                </div>
              </div>
            </div>
          </div>
  ...
  return (
    <form
      action={async () => {
        ...
        const { sessionId, url } = await createCheckoutSession(productId)
        if (url) {
          redirect(url)
        }
      }}
