...
export const metadata = {
  ...
  description: "Healthy meals, protein bars, and energy drinks for your fitness goals",
}
  ...
  const subcategories = [
    {
      id: "healthy-meals",
      name: "Healthy Meals",
      description: "Nutritious meal prep options designed for muscle growth and recovery",
      href: "/store/food-drinks/healthy-meals",
    },
    {
      id: "protein-bars",
      name: "Protein Bars",
      description: "Convenient high-protein snacks for on-the-go nutrition",
      href: "/store/food-drinks/protein-bars",
    },
    {
      id: "energy-drinks",
      name: "Energy Drinks",
      description: "Energizing beverages to fuel your workouts and training",
        ...
        <div className="mx-auto max-w-7xl px-4 py-12">
          <div className="mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Premium nutrition to support your fitness goals and training
            </p>
          </div>
