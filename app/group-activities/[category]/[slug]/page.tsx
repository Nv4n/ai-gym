					...
					<CardContent className="p-6">
						...
						<div className="space-y-4 text-muted-foreground">
							<div>
								...
								<p>
									This {activity.duration} class is designed
									for {activity.level} participants. You'll be
									guided through a structured session by our
							...
							<div>
								...
								<ul className="list-disc list-inside space-y-1">
									...
									<li>
										Positive energy and willingness to
										challenge yourself
									</li>
								</ul>
							</div>
							<div>
								...
								<p>
									Cancel up to 12 hours before class start
									time for a full credit. Late cancellations
			...
			<Dialog open={modalOpen} onOpenChange={setModalOpen}>
				<DialogContent className="max-w-3xl">
					<DialogHeader>
						...
						<DialogDescription>
							Select a date and time for your class reservation
						</DialogDescription>
					</DialogHeader>
						...
						<div>
							...
							{selectedDate ? (
								availableTimes.length > 0 ? (
									...
									<p className="text-sm text-muted-foreground">
										No classes available on {dayOfWeek}s
									</p>
								)
							) : (
								<p className="text-sm text-muted-foreground">
