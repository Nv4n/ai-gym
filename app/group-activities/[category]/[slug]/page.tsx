						...
						<CardContent className="p-6">
							...
							<div className="space-y-4 text-muted-foreground">
								<div>
									...
									<p>
										This {activity.duration} class is
										designed for {activity.level}{" "}
										participants. You'll be guided through a
										structured session by our experienced
