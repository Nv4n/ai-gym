  ...
  const mainSections = [
    {
      id: "store",
      title: "Store",
      description: "Shop premium supplements, equipment, and healthy food & drinks",
      icon: ShoppingBag,
      href: "/store",
      color: "text-blue-500",
    ...
    },
    {
      ...
      description: "Join expert-led fitness classes and coaching sessions",
      icon: Users,
      ...
      <main className="min-h-screen">
        ...
        <section className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground py-20">
          <div className="mx-auto max-w-7xl px-4 text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Welcome to FitHub Gym</h1>
            <p className="text-xl mb-8 opacity-90">Your complete fitness destination - shop, train, and grow with us</p>
        ...
        <section className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 py-16">
          <div className="mx-auto max-w-7xl px-4 text-center">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <h2 className="text-3xl font-bold">AI-Powered Fitness</h2>
            </div>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Get personalized workout plans and diet recommendations powered by artificial intelligence
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <Button asChild size="lg">
                <Link href="/gym/ai-workouts">Try AI Workouts</Link>
              </Button>
              <Button asChild size="lg" variant="outline">
                <Link href="/gym/ai-diet-plans">Get Diet Plan</Link>
              </Button>
            </div>
          </div>
        </section>
