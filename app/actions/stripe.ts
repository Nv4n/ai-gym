    ...
    line_items: [
      {
        price_data: {
          ...
          product_data: {
            ...
            description: `Training session on ${new Date(booking.date).toLocaleDateString()} at ${booking.timeSlot}`,
          },
...
export async function createCartCheckoutSession(cartItems: Array<{ product: any; quantity: number }>) {
