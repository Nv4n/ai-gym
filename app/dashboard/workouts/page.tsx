    ...
    <main className="min-h-screen bg-background">
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold mb-2">My Workout Plans</h1>
          <p className="text-lg text-muted-foreground">Track your workout plans and progress</p>
        </div>
        ...
        {!workoutPlans || workoutPlans.length === 0 ? (
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-muted-foreground mb-4">Choose a workout plan to get started</p>
              <div className="flex gap-4">
                <Button asChild>
                  <Link href="/gym/workouts">Browse Workout Plans</Link>
                </Button>
                <Button asChild variant="outline">
                  <Link href="/gym/ai-workouts">Generate AI Workout</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
                    ...
                    <Card key={plan.id}>
                      ...
                      <CardContent>
                        <p className="text-sm text-muted-foreground mb-4">
                          Started on {new Date(plan.created_at).toLocaleDateString()}
                        </p>
                        <div className="flex gap-2">
                          <Button asChild size="sm" className="flex-1">
                            <Link href={`/gym/workouts/${plan.plan_slug}`}>View Plan</Link>
                          </Button>
