...
import { Users, ShoppingBag, Calendar, TrendingUp, Package, DollarSign } from "lucide-react"
    ...
    <main className="min-h-screen bg-background">
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="mb-12">
          ...
          <p className="text-lg text-muted-foreground">Manage your gym business and monitor performance</p>
        </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">View and manage class bookings</p>
                    </div>
                  </div>
                </a>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-3 rounded-lg bg-muted">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">Order #8347 - $89.99</p>
                ...
                <div className="flex items-start gap-3 p-3 rounded-lg bg-muted">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-sm">Class reservation made</p>
                    <p className="text-xs text-muted-foreground">Yoga - Tomorrow 9:00 AM</p>
                ...
                <div className="flex items-start gap-3 p-3 rounded-lg bg-muted">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">Whey Protein - 8 units left</p>
